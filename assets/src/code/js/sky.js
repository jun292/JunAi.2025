document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendMessage() {
        ...
        const systemResponse = {
            role: "model",
            parts: [{ text: "Halo kakak. Kenalin, nama aku Sky" }]
        };
    ...
    function resetChat() {
        ...
        addMessageToUI([{ text: "yahhh... mulai dari awal lagi deh" }], false);
        clearImageSelection();
    ...
    // Load Music List
    const musicItems = [
        { src: "assets/src/song/Maafkan Diriku - Crescendo.mp3", thumbnail: "assets/src/img/thumbnail/Maafkan Diriku - Crescendo.jpg", title: "Maafkan Diriku - Crescendo" },
        { src: "assets/src/song/Masa Lalu - Chaeroel.mp3", thumbnail: "assets/src/img/thumbnail/Masa Lalu - Chaeroel.jpg", title: "Masa Lalu - Chaeroel" },
        { src: "assets/src/song/Masa Depanmu - Nielz Muzik.mp3", thumbnail: "assets/src/img/thumbnail/Masa Depanmu - Nielz Muzik.jpg", title: "Masa Depanmu - Nielz Muzik, Danil Muzik, Chaeroel" }
    ...
    const initialPageId = window.location.hash.substring(1) || 'chat-ai';
    const validPageIds = Array.from(pages).map(p => p.id);
    showPage(validPageIds.includes(initialPageId) ? initialPageId : 'chat-ai');
